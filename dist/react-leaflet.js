(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactLeaflet"] = factory(require("react"), require("react-dom"));
	else
		root["ReactLeaflet"] = factory(root["React"], root["ReactDOM"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _leafletCordova2 = _interopRequireDefault(_leafletCordova);
	...
	var _Marker2 = __webpack_require__(100);

	var _Marker3 = _interopRequireDefault(_Marker2);

	var _MultiPolygon2 = __webpack_require__(101);

	var _MultiPolygon3 = _interopRequireDefault(_MultiPolygon2);

	var _MultiPolyline2 = __webpack_require__(102);
	...
	var _Polygon2 = __webpack_require__(103);

	var _Polygon3 = _interopRequireDefault(_Polygon2);

	var _Polyline2 = __webpack_require__(104);

	var _Polyline3 = _interopRequireDefault(_Polyline2);

	var _Popup2 = __webpack_require__(105);
	...
	var _ScaleControl2 = __webpack_require__(108);

	var _ScaleControl3 = _interopRequireDefault(_ScaleControl2);

	var _TileLayer2 = __webpack_require__(109);
	...
	var setIconDefaultImagePath = exports.setIconDefaultImagePath = function setIconDefaultImagePath(path) {
	  _leafletCordova2.default.Icon.Default.imagePath = path;
	};
	...
	L.TileLayer.CordovaSql = L.TileLayer.extend({
		...
		getTileUrl: function (tilePoint, tile) {
			try {
				...
				this._sqldb.executeSql("SELECT tileimage FROM tiles WHERE z = ? AND x = ? AND y = ?", [z, x, y], function (res) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react.PropTypes.instanceOf(_leafletCordova.Map);
	...
	var AttributionControl = function (_MapControl) {
	  ...
	  _createClass(AttributionControl, [{
	    ...
	    value: function componentWillMount() {
	      this.leafletElement = _leafletCordova.control.attribution(this.props);
	    }
	  }]);
	...
	var CanvasTileLayer = function (_BaseTileLayer) {
	  ...
	  _createClass(CanvasTileLayer, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      this.leafletElement = _leafletCordova.tileLayer.canvas(this.props);
	    }
	  }]);
	...
	var Circle = function (_Path) {
	  ...
	  _createClass(Circle, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      this.leafletElement = (0, _leafletCordova.circle)(center, radius, props);
	    }
	  }, {
	    key: 'componentDidUpdate',
	    value: function componentDidUpdate(prevProps) {
	...
	var CircleMarker = function (_Path) {
	  ...
	  _createClass(CircleMarker, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      this.leafletElement = (0, _leafletCordova.circleMarker)(center, props);
	    }
	  }, {
	    key: 'componentDidUpdate',
	    value: function componentDidUpdate(prevProps) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FeatureGroup = function (_Path) {
	  ...
	  _createClass(FeatureGroup, [{
	    ...
	    key: 'componentWillMount',
	    value: function componentWillMount() {
	      this.leafletElement = (0, _leafletCordova.featureGroup)();
	    }
	  }, {
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	...
	var GeoJson = function (_Path) {
	  ...
	  _createClass(GeoJson, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      this.leafletElement = (0, _leafletCordova.geoJson)(data, props);
	    }
	  }, {
	    key: 'componentDidUpdate',
	    value: function componentDidUpdate(prevProps) {
	...
	var ImageOverlay = function (_MapLayer) {
	  ...
	  _createClass(ImageOverlay, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      this.leafletElement = (0, _leafletCordova.imageOverlay)(url, bounds, props);
	    }
	  }, {
	    key: 'componentDidUpdate',
	    value: function componentDidUpdate(prevProps) {
	...
	var LayerGroup = function (_MapLayer) {
	  ...
	  _createClass(LayerGroup, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      this.leafletElement = (0, _leafletCordova.layerGroup)();
	    }
	  }]);
	...
	var LayersControl = function (_MapControl) {
	  ...
	  _createClass(LayersControl, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      this.leafletElement = _leafletCordova.control.layers(undefined, undefined, options);
	      this.controlProps = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _uniqueId2 = __webpack_require__(85);
	...
	var _isUndefined2 = __webpack_require__(99);
	...
	var Map = function (_MapComponent) {
	  ...
	  _createClass(Map, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      this.leafletElement = _leafletCordova2.default.map(this.state.id, props);
	    ...
	    value: function shouldUpdateBounds(next, prev) {
	      if (!prev) return true;
	      next = _leafletCordova2.default.latLngBounds(next);
	      prev = _leafletCordova2.default.latLngBounds(prev);
	...
	Map.childContextTypes = {
	  map: _react.PropTypes.instanceOf(_leafletCordova2.default.Map)
	};
	exports.default = Map;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Marker = function (_MapLayer) {
	  ...
	  _createClass(Marker, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      this.leafletElement = (0, _leafletCordova.marker)(position, props);
	    }
	  }, {
	    key: 'componentDidUpdate',
	    value: function componentDidUpdate(prevProps) {
	...
	Marker.propTypes = {
	  icon: _react.PropTypes.instanceOf(_leafletCordova.Icon),
	  opacity: _react.PropTypes.number,
	...
	var MultiPolygon = function (_Path) {
	  ...
	  _createClass(MultiPolygon, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      this.leafletElement = (0, _leafletCordova.multiPolygon)(polygons, props);
	    }
	  }, {
	    key: 'componentDidUpdate',
	    value: function componentDidUpdate(prevProps) {
	...
	var MultiPolyline = function (_Path) {
	  ...
	  _createClass(MultiPolyline, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      this.leafletElement = (0, _leafletCordova.multiPolyline)(polylines, props);
	    }
	  }, {
	    key: 'componentDidUpdate',
	    value: function componentDidUpdate(prevProps) {
	...
	var Polygon = function (_Path) {
	  ...
	  _createClass(Polygon, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      this.leafletElement = (0, _leafletCordova.polygon)(positions, props);
	    }
	  }, {
	    key: 'componentDidUpdate',
	    value: function componentDidUpdate(prevProps) {
	...
	var Polyline = function (_Path) {
	  ...
	  _createClass(Polyline, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      this.leafletElement = (0, _leafletCordova.polyline)(positions, props);
	    }
	  }, {
	    key: 'componentDidUpdate',
	    value: function componentDidUpdate(prevProps) {
	...
	var Popup = function (_MapComponent) {
	  ...
	  _createClass(Popup, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      this.leafletElement = (0, _leafletCordova.popup)(props, this.context.popupContainer);
	...
	var Rectangle = function (_Path) {
	  ...
	  _createClass(Rectangle, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      this.leafletElement = (0, _leafletCordova.rectangle)(bounds, props);
	    }
	  }, {
	    key: 'componentDidUpdate',
	    value: function componentDidUpdate(prevProps) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ZoomControl = function (_MapControl) {
	  ...
	  _createClass(ZoomControl, [{
	    key: 'componentWillMount',
	    value: function componentWillMount() {
	      this.leafletElement = _leafletCordova.control.scale(this.props);
	    }
	  }]);
	...
	var TileLayer = function (_BaseTileLayer) {
	  ...
	  _createClass(TileLayer, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      this.leafletElement = (0, _leafletCordova.tileLayer)(url, props);
	    }
	  }, {
	    key: 'componentDidUpdate',
	    value: function componentDidUpdate(prevProps) {
	...
	var WMSTileLayer = function (_BaseTileLayer) {
	  ...
	  _createClass(WMSTileLayer, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      this.leafletElement = _leafletCordova.tileLayer.wms(url, props);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ZoomControl = function (_MapControl) {
	  ...
	  _createClass(ZoomControl, [{
	    key: 'componentWillMount',
	    value: function componentWillMount() {
	      this.leafletElement = _leafletCordova.control.zoom(this.props);
	    }
	  }]);
